 ...
 */
final class Version20231120131300 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE clanek (id INT AUTO_INCREMENT NOT NULL, id_recenzni_rizeni_id INT NOT NULL, user_id_id INT NOT NULL, stav_redakce INT NOT NULL, stav_autor INT NOT NULL, INDEX IDX_60591765530ADD1B (id_recenzni_rizeni_id), INDEX IDX_605917659D86650F (user_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
