 ...
 */
final class Version20231121123924 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE clanek (id INT AUTO_INCREMENT NOT NULL, recenzni_rizeni_id INT NOT NULL, user_id INT NOT NULL, stav_redakce INT NOT NULL, stav_autor INT NOT NULL, INDEX IDX_60591765D0286FB4 (recenzni_rizeni_id), INDEX IDX_60591765A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE komentar_clanek (id INT AUTO_INCREMENT NOT NULL, verze_clanku_id INT NOT NULL, user_id INT NOT NULL, datum DATE NOT NULL, text VARCHAR(10000) NOT NULL, INDEX IDX_3415CE5350D48026 (verze_clanku_id), INDEX IDX_3415CE53A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE namitka (id INT AUTO_INCREMENT NOT NULL, clanek_id INT NOT NULL, datum DATE NOT NULL, text_namitky VARCHAR(10000) NOT NULL, UNIQUE INDEX UNIQ_4D851C623F69A15D (clanek_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE recenzni_rizeni (id INT AUTO_INCREMENT NOT NULL, tisk_id INT NOT NULL, od DATE NOT NULL, do DATE NOT NULL, UNIQUE INDEX UNIQ_48A89B9161E583EB (tisk_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE verze_clanku (id INT AUTO_INCREMENT NOT NULL, clanek_id INT NOT NULL, datum_nahrani DATE NOT NULL, soubor_clanek VARCHAR(1000) NOT NULL, zpristupnen_recenzentum TINYINT(1) NOT NULL, INDEX IDX_FE9155453F69A15D (clanek_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
