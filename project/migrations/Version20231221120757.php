 ...
 */
final class Version20231221120757 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE clanek (id INT AUTO_INCREMENT NOT NULL, recenzni_rizeni_id INT NOT NULL, user_id INT NOT NULL, stav_redakce VARCHAR(50) NOT NULL, stav_autor VARCHAR(50) NOT NULL, nazev_clanku VARCHAR(50) NOT NULL, UNIQUE INDEX UNIQ_60591765D6C64659 (nazev_clanku), INDEX IDX_60591765D0286FB4 (recenzni_rizeni_id), INDEX IDX_60591765A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE ukol (id INT AUTO_INCREMENT NOT NULL, clanek_id INT NOT NULL, user_id INT NOT NULL, deadline VARCHAR(10) NOT NULL, UNIQUE INDEX UNIQ_9F46F1683F69A15D (clanek_id), INDEX IDX_9F46F168A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
